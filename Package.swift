...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            path: "Sources/BagbutikGameCenter"
        ),
        .target(
            name: "BagbutikTestFlight",
            dependencies: [
        ...
        .target(
            ...
            path: "Sources/BagbutikXcodeCloud"
        ),
