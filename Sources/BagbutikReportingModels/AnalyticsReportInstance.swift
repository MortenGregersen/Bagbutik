...
/**
 ...
 [`object AnalyticsReportInstance.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AnalyticsReportInstance/Attributes-data.dictionary)

 Attributes that describe an analytics report instance resource.

 ### Dictionaries

 [`object AnalyticsReportInstance.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AnalyticsReportInstance/Relationships-data.dictionary)
