...
public struct CustomerReview: Codable, Sendable, Identifiable {
    ...
    public struct Relationships: Codable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            reviewTerritory = try container.decodeIfPresent(ReviewTerritory.self, forKey: "reviewTerritory")
        }

        public func encode(to encoder: Encoder) throws {
            var container = encoder.container(keyedBy: AnyCodingKey.self)
            try container.encodeIfPresent(response, forKey: "response")
            try container.encodeIfPresent(reviewTerritory, forKey: "reviewTerritory")
        }
        ...
        public struct ReviewTerritory: Codable, Sendable {
            @NullCodable public var data: Data?
