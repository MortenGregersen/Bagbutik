...
/**
 ...
 [`object Webhook.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/Webhook/Attributes-data.dictionary)

 Attributes that describe a webhook resource.

 [`object Webhook.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/Webhook/Relationships-data.dictionary)
