...
/**
 ...
 [`object ScmRepository.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/ScmRepository/Attributes-data.dictionary)

 The attributes that describe a Repositories resource.

 [`object ScmRepository.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/ScmRepository/Relationships-data.dictionary)
