...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v2-gameCenterLeaderboardSets-_id_-gameCenterLeaderboards>
     ...
     */
    static func listGameCenterLeaderboardsForGameCenterLeaderboardSetsV2(id: String,
                                                                         fields: [ListGameCenterLeaderboardsForGameCenterLeaderboardSetsV2.Field]? = nil,
                                                                         filters: [ListGameCenterLeaderboardsForGameCenterLeaderboardSetsV2.Filter]? = nil,
                                                                         includes: [ListGameCenterLeaderboardsForGameCenterLeaderboardSetsV2.Include]? = nil,
                                                                         limits: [ListGameCenterLeaderboardsForGameCenterLeaderboardSetsV2.Limit]? = nil) -> Request<GameCenterLeaderboardsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterLeaderboardsForGameCenterLeaderboardSetsV2 {
    /**
