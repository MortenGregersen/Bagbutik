...
public extension Request {
     ...
     */
    static func listGameCenterLeaderboardSetsV2ForGameCenterGroupV1(id: String,
                                                                    fields: [ListGameCenterLeaderboardSetsV2ForGameCenterGroupV1.Field]? = nil,
                                                                    filters: [ListGameCenterLeaderboardSetsV2ForGameCenterGroupV1.Filter]? = nil,
                                                                    includes: [ListGameCenterLeaderboardSetsV2ForGameCenterGroupV1.Include]? = nil,
                                                                    limits: [ListGameCenterLeaderboardSetsV2ForGameCenterGroupV1.Limit]? = nil) -> Request<GameCenterLeaderboardSetsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterLeaderboardSetsV2ForGameCenterGroupV1 {
    /**
