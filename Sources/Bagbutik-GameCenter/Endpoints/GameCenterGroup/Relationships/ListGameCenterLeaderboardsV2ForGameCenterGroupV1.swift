...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterGroups-_id_-gameCenterLeaderboardsV2>
     ...
     */
    static func listGameCenterLeaderboardsV2ForGameCenterGroupV1(id: String,
                                                                 fields: [ListGameCenterLeaderboardsV2ForGameCenterGroupV1.Field]? = nil,
                                                                 filters: [ListGameCenterLeaderboardsV2ForGameCenterGroupV1.Filter]? = nil,
                                                                 includes: [ListGameCenterLeaderboardsV2ForGameCenterGroupV1.Include]? = nil,
                                                                 limits: [ListGameCenterLeaderboardsV2ForGameCenterGroupV1.Limit]? = nil) -> Request<GameCenterLeaderboardsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterLeaderboardsV2ForGameCenterGroupV1 {
    /**
