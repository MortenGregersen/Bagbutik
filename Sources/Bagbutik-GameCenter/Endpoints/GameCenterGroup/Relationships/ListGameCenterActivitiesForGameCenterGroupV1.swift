...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterGroups-_id_-gameCenterActivities>
     ...
     */
    static func listGameCenterActivitiesForGameCenterGroupV1(id: String,
                                                             fields: [ListGameCenterActivitiesForGameCenterGroupV1.Field]? = nil,
                                                             includes: [ListGameCenterActivitiesForGameCenterGroupV1.Include]? = nil,
                                                             limits: [ListGameCenterActivitiesForGameCenterGroupV1.Limit]? = nil) -> Request<GameCenterActivitiesResponse, ErrorResponse> {
        .init(
...
public enum ListGameCenterActivitiesForGameCenterGroupV1 {
    /**
