...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterGroups-_id_-gameCenterAchievementsV2>
     ...
     */
    static func listGameCenterAchievementsV2ForGameCenterGroupV1(id: String,
                                                                 fields: [ListGameCenterAchievementsV2ForGameCenterGroupV1.Field]? = nil,
                                                                 filters: [ListGameCenterAchievementsV2ForGameCenterGroupV1.Filter]? = nil,
                                                                 includes: [ListGameCenterAchievementsV2ForGameCenterGroupV1.Include]? = nil,
                                                                 limits: [ListGameCenterAchievementsV2ForGameCenterGroupV1.Limit]? = nil) -> Request<GameCenterAchievementsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterAchievementsV2ForGameCenterGroupV1 {
    /**
