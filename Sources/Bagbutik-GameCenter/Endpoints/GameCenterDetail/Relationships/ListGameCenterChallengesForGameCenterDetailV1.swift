...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterDetails-_id_-gameCenterChallenges>
     ...
     */
    static func listGameCenterChallengesForGameCenterDetailV1(id: String,
                                                              fields: [ListGameCenterChallengesForGameCenterDetailV1.Field]? = nil,
                                                              filters: [ListGameCenterChallengesForGameCenterDetailV1.Filter]? = nil,
                                                              includes: [ListGameCenterChallengesForGameCenterDetailV1.Include]? = nil,
                                                              limits: [ListGameCenterChallengesForGameCenterDetailV1.Limit]? = nil) -> Request<GameCenterChallengesResponse, ErrorResponse> {
        .init(
...
public enum ListGameCenterChallengesForGameCenterDetailV1 {
    /**
