...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterDetails-_id_-gameCenterLeaderboardSetsV2>
     ...
     */
    static func listGameCenterLeaderboardSetsV2ForGameCenterDetailV1(id: String,
                                                                     fields: [ListGameCenterLeaderboardSetsV2ForGameCenterDetailV1.Field]? = nil,
                                                                     filters: [ListGameCenterLeaderboardSetsV2ForGameCenterDetailV1.Filter]? = nil,
                                                                     includes: [ListGameCenterLeaderboardSetsV2ForGameCenterDetailV1.Include]? = nil,
                                                                     limits: [ListGameCenterLeaderboardSetsV2ForGameCenterDetailV1.Limit]? = nil) -> Request<GameCenterLeaderboardSetsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterLeaderboardSetsV2ForGameCenterDetailV1 {
    /**
