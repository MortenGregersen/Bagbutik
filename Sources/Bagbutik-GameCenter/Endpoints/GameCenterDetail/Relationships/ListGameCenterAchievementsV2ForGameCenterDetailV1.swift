...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-gameCenterDetails-_id_-gameCenterAchievementsV2>
     ...
     */
    static func listGameCenterAchievementsV2ForGameCenterDetailV1(id: String,
                                                                  fields: [ListGameCenterAchievementsV2ForGameCenterDetailV1.Field]? = nil,
                                                                  filters: [ListGameCenterAchievementsV2ForGameCenterDetailV1.Filter]? = nil,
                                                                  includes: [ListGameCenterAchievementsV2ForGameCenterDetailV1.Include]? = nil,
                                                                  limits: [ListGameCenterAchievementsV2ForGameCenterDetailV1.Limit]? = nil) -> Request<GameCenterAchievementsV2Response, ErrorResponse> {
        .init(
...
public enum ListGameCenterAchievementsV2ForGameCenterDetailV1 {
    /**
