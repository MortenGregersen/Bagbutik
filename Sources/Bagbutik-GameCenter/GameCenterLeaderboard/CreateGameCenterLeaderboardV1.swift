...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/create_a_leaderboard>
    ...
    static func createGameCenterLeaderboardV1(requestBody: GameCenterLeaderboardCreateRequest) -> Request<GameCenterLeaderboardResponse, ErrorResponse> {
        .init(path: "/v1/gameCenterLeaderboards", method: .post, requestBody: requestBody)
    }
}
