...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/create_a_leaderboard_set_image>
    ...
    static func createGameCenterLeaderboardSetImageV1(requestBody: GameCenterLeaderboardSetImageCreateRequest) -> Request<GameCenterLeaderboardSetImageResponse, ErrorResponse> {
        .init(path: "/v1/gameCenterLeaderboardSetImages", method: .post, requestBody: requestBody)
    }
}
