...
/**
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetversionsv2response>
 */
public struct GameCenterLeaderboardSetVersionsV2Response: Codable, Sendable, PagedResponse {
    public typealias Data = GameCenterLeaderboardSetVersionV2
    ...
    public func getLeaderboardSet(for gameCenterLeaderboardSetVersionV2: GameCenterLeaderboardSetVersionV2) -> GameCenterLeaderboardSetV2? {
        ...
        }.first { $0.id == gameCenterLeaderboardSetVersionV2.relationships?.leaderboardSet?.data?.id }
    }

    public func getLocalizations(for gameCenterLeaderboardSetVersionV2: GameCenterLeaderboardSetVersionV2) -> [GameCenterLeaderboardSetLocalizationV2] {
        guard let localizationIds = gameCenterLeaderboardSetVersionV2.relationships?.localizations?.data?.map(\.id),
