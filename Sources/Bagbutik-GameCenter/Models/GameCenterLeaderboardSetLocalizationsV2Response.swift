 ...
 */
public struct GameCenterLeaderboardSetLocalizationsV2Response: Codable, Sendable, PagedResponse {
    public typealias Data = GameCenterLeaderboardSetLocalizationV2
    ...
    public func getImage(for gameCenterLeaderboardSetLocalizationV2: GameCenterLeaderboardSetLocalizationV2) -> GameCenterLeaderboardSetImageV2? {
        included?.compactMap { relationship -> GameCenterLeaderboardSetImageV2? in
            ...
            return image
        }.first { $0.id == gameCenterLeaderboardSetLocalizationV2.relationships?.image?.data?.id }
    }

    public func getVersion(for gameCenterLeaderboardSetLocalizationV2: GameCenterLeaderboardSetLocalizationV2) -> GameCenterLeaderboardSetVersionV2? {
        included?.compactMap { relationship -> GameCenterLeaderboardSetVersionV2? in
            ...
            return version
        }.first { $0.id == gameCenterLeaderboardSetLocalizationV2.relationships?.version?.data?.id }
    }
