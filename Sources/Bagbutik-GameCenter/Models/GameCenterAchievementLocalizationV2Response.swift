...
/**
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementlocalizationv2response>
 */
public struct GameCenterAchievementLocalizationV2Response: Codable, Sendable {
    ...
    public func getImage() -> GameCenterAchievementImageV2? {
    ...
    public func getVersion() -> GameCenterAchievementVersionV2? {
