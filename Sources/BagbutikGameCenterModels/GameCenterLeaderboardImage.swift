...
/**
 ...
 [`object GameCenterLeaderboardImage.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardImage/Attributes-data.dictionary)

 Attributes that describe a leaderboard resource.

 [`object GameCenterLeaderboardImage.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardImage/Relationships-data.dictionary)
