...
/**
 ...
 [`object GameCenterLeaderboardSetImageV2.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardSetImageV2/Attributes-data.dictionary)

 Attributes that describe a Game Center leaderboard set image v2 resource.

 [`object GameCenterLeaderboardSetImageV2.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardSetImageV2/Relationships-data.dictionary)
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/gamecenterleaderboardsetimagev2>
 */
public struct GameCenterLeaderboardSetImageV2: Codable, Sendable, Identifiable {
    ...
    public struct Relationships: Codable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            let container = try decoder.container(keyedBy: AnyCodingKey.self)
            localization = try container.decodeIfPresent(Localization.self, forKey: "localization")
        }
