...
/**
 ...
 [`object GameCenterLeaderboardUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardUpdateRequest/Data-data.dictionary)
