...
/**
 ...
 [`object GameCenterLeaderboard.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboard/Attributes-data.dictionary)

 Attributes that describe a leaderboard resource.

 [`object GameCenterLeaderboard.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboard/Relationships-data.dictionary)
