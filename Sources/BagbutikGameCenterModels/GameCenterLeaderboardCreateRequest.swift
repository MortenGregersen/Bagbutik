...
/**
 ...
 [`object GameCenterLeaderboardCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardCreateRequest/Data-data.dictionary)
