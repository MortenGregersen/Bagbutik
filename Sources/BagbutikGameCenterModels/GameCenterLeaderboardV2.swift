...
/**
 ...
 [`object GameCenterLeaderboardV2.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardV2/Attributes-data.dictionary)

 Attributes that describe a Game Center leaderboard v2 resource.

 [`object GameCenterLeaderboardV2.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterLeaderboardV2/Relationships-data.dictionary)
