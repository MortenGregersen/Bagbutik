...
/**
 ...
 [`object GameCenterAchievementCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAchievementCreateRequest/Data-data.dictionary)
