...
/**
 ...
 [`object GameCenterAchievement.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAchievement/Attributes-data.dictionary)

 Attributes that describe a achievement resource.

 [`object GameCenterAchievement.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAchievement/Relationships-data.dictionary)
...
public struct GameCenterAchievement: Codable, Sendable, Identifiable {
    ...
    public struct Relationships: Codable, Sendable {
        ...
        public struct GroupAchievement: Codable, Sendable {
            @NullCodable public var data: Data?
            public var links: RelationshipLinks?
