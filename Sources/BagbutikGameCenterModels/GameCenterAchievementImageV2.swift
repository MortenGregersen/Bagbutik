...
/**
 ...
 [`object GameCenterAchievementImageV2.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAchievementImageV2/Attributes-data.dictionary)

 Attributes that describe a Game Center achievement image v2 resource.

 [`object GameCenterAchievementImageV2.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAchievementImageV2/Relationships-data.dictionary)
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/gamecenterachievementimagev2>
 */
public struct GameCenterAchievementImageV2: Codable, Sendable, Identifiable {
