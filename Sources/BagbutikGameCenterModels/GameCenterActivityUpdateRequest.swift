...
/**
 ...
 [`object GameCenterActivityUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterActivityUpdateRequest/Data-data.dictionary)
