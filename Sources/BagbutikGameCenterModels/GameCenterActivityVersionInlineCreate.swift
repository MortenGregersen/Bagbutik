...
/**
 ...
 [`object GameCenterActivityVersionInlineCreate.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterActivityVersionInlineCreate/Attributes-data.dictionary)

 Attributes that describe an activity version resource that you create while creating an activity.

 [`object GameCenterActivityVersionInlineCreate.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterActivityVersionInlineCreate/Relationships-data.dictionary)
