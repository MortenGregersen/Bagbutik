...
public extension Request {
    /**
     ...
     [`Create an app preview set`](https://developer.apple.com/documentation/AppStoreConnectAPI/POST-v1-appPreviewSets)

     Add a new app preview set to an App Store version localization for a specific app preview type and display size.

     [`Delete an app preview set`](https://developer.apple.com/documentation/AppStoreConnectAPI/DELETE-v1-appPreviewSets-_id_)

     Delete an app preview set and all of its previews.

     [`List all app previews for an app preview set`](https://developer.apple.com/documentation/AppStoreConnectAPI/GET-v1-appPreviewSets-_id_-appPreviews)

     List all ordered app previews in a preview set.

     [`Get all app preview ids for an app preview set`](https://developer.apple.com/documentation/AppStoreConnectAPI/GET-v1-appPreviewSets-_id_-relationships-appPreviews)

     Get the ordered app preview IDs in a preview set.

     [`Replace all app previews for an app preview set`](https://developer.apple.com/documentation/AppStoreConnectAPI/PATCH-v1-appPreviewSets-_id_-relationships-appPreviews)
