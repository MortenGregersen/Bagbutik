...
/**
 ...
 [`object SubscriptionPlanAvailability.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionPlanAvailability/Attributes-data.dictionary)

 Attributes that describe a subscription plan availability resource.

 [`object SubscriptionPlanAvailability.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionPlanAvailability/Relationships-data.dictionary)
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/subscriptionplanavailability>
 */
public struct SubscriptionPlanAvailability: Codable, Sendable, Identifiable {
