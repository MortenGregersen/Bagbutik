...
/**
 ...
 [`object AppEventLocalization.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEventLocalization/Attributes-data.dictionary)

 Attributes that describe an app event localization resource.

 [`object AppEventLocalization.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEventLocalization/Relationships-data.dictionary)
