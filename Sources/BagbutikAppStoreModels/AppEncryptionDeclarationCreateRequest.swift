...
/**
 ...
 [`object AppEncryptionDeclarationCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEncryptionDeclarationCreateRequest/Data-data.dictionary)
