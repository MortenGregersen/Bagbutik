...
/**
 ...
 [`object SubscriptionGroupLocalizationV2.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionGroupLocalizationV2/Attributes-data.dictionary)

 Attributes that describe a subscription group localization resource.

 [`object SubscriptionGroupLocalizationV2.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionGroupLocalizationV2/Relationships-data.dictionary)
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/subscriptiongrouplocalizationv2>
 */
public struct SubscriptionGroupLocalizationV2: Codable, Sendable, Identifiable {
