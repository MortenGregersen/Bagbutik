...
/**
 ...
 [`object EndUserLicenseAgreementUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/EndUserLicenseAgreementUpdateRequest/Data-data.dictionary)
