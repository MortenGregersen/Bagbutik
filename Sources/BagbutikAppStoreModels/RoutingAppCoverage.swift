...
/**
 ...
 [`object RoutingAppCoverage.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/RoutingAppCoverage/Attributes-data.dictionary)

 Attributes that describe a Routing App Coverages resource.

 [`object RoutingAppCoverage.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/RoutingAppCoverage/Relationships-data.dictionary)
