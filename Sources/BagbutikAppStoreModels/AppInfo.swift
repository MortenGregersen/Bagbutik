...
/**
 ...
 [`object AppInfo.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppInfo/Attributes-data.dictionary)

 Attributes that describe an App Infos resource.

 [`object AppInfo.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppInfo/Relationships-data.dictionary)
