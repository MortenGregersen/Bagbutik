...
/**
 ...
 [`object AppScreenshotCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppScreenshotCreateRequest/Data-data.dictionary)
...
public struct AppScreenshotCreateRequest: Codable, Sendable, RequestBody {
    ...
    public struct Data: Codable, Sendable {
        ...
        public struct Relationships: Codable, Sendable {
            ...
            public init(from decoder: Decoder) throws {
                let container = try decoder.container(keyedBy: AnyCodingKey.self)
                appScreenshotSet = try container.decode(AppScreenshotSet.self, forKey: "appScreenshotSet")
            }
