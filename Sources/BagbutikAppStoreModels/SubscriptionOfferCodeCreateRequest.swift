...
/**
 ...
 [`object SubscriptionOfferCodeCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionOfferCodeCreateRequest/Data-data.dictionary)
