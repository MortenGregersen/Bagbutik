...
/**
 ...
 [`object PromotedPurchase.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/PromotedPurchase/Attributes-data.dictionary)

 Attributes that describe a promoted purchase resource.

 [`object PromotedPurchase.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/PromotedPurchase/Relationships-data.dictionary)
