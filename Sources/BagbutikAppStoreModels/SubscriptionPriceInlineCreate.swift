...
/**
 ...
 [`object SubscriptionPriceInlineCreate.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionPriceInlineCreate/Attributes-data.dictionary)

 Attributes that describe a subscription price inline create resource.

 [`object SubscriptionPriceInlineCreate.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionPriceInlineCreate/Relationships-data.dictionary)
 ...
 */
public struct SubscriptionPriceInlineCreate: Codable, Sendable, Identifiable {
