...
/**
 ...
 [`object WinBackOffer.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/WinBackOffer/Attributes-data.dictionary)

 Attributes that describe a winback offer resource.

 [`object WinBackOffer.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/WinBackOffer/Relationships-data.dictionary)
