...
/**
 ...
 [`object AppEventVideoClipCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEventVideoClipCreateRequest/Data-data.dictionary)
