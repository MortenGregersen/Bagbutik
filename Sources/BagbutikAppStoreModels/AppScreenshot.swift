...
/**
 ...
 [`object AppScreenshot.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppScreenshot/Attributes-data.dictionary)

 Attributes that describe an App Screenshots resource.

 [`object AppScreenshot.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppScreenshot/Relationships-data.dictionary)
