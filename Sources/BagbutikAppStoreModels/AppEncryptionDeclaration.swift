...
/**
 ...
 [`object AppEncryptionDeclaration.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEncryptionDeclaration/Attributes-data.dictionary)

 Attributes that describe an App Encryption Declarations resource.

 [`object AppEncryptionDeclaration.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppEncryptionDeclaration/Relationships-data.dictionary)
