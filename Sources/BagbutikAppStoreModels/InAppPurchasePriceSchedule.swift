...
/**
 ...
 [`object InAppPurchasePriceSchedule.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/InAppPurchasePriceSchedule/Relationships-data.dictionary)
