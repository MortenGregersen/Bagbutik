...
/**
 ...
 [`object AppPricePointV3.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppPricePointV3/Attributes-data.dictionary)

 Attributes that describe an app price point v3 resource.

 [`object AppPricePointV3.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppPricePointV3/Relationships-data.dictionary)
