...
/**
 ...
 [`object SubscriptionGroup.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionGroup/Attributes-data.dictionary)

 Attributes that describe a subscription group resource.

 [`object SubscriptionGroup.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/SubscriptionGroup/Relationships-data.dictionary)
