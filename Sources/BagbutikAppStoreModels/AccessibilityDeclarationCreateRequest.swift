...
/**
 ...
 [`object AccessibilityDeclarationCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AccessibilityDeclarationCreateRequest/Data-data.dictionary)
