...
/**
 ...
 [`object AppCategory.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppCategory/Attributes-data.dictionary)

 Attributes that describe an App Categories resource.

 [`object AppCategory.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppCategory/Relationships-data.dictionary)
