...
/**
 ...
 [`object ReviewSubmissionUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/ReviewSubmissionUpdateRequest/Data-data.dictionary)
