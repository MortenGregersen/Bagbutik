...
/**
 ...
 [`object AppStoreReviewDetailUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppStoreReviewDetailUpdateRequest/Data-data.dictionary)
