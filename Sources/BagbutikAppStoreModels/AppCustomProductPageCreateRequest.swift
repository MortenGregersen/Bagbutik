...
/**
 ...
 [`object AppCustomProductPageCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppCustomProductPageCreateRequest/Data-data.dictionary)
