...
/**
 ...
 [`object AppStoreVersionPromotionResponse`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppStoreVersionPromotionResponse)

 A response containing a single App Store version promotion configuration.

 [`object AppStoreVersionPromotionCreateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/AppStoreVersionPromotionCreateRequest/Data-data.dictionary)
 ...
 Full documentation:
 <https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionpromotioncreaterequest>
 */
public struct AppStoreVersionPromotionCreateRequest: Codable, Sendable, RequestBody {
    ...
    public struct Data: Codable, Sendable {
        ...
        public struct Relationships: Codable, Sendable {
            ...
            public struct AppStoreVersionExperimentTreatment: Codable, Sendable {
                public let data: Data
