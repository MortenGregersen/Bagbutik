...
/**
 ...
 [`object GameCenterAppVersion.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAppVersion/Attributes-data.dictionary)

 Attributes that describe a Game Center app version resource.

 [`object GameCenterAppVersion.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/GameCenterAppVersion/Relationships-data.dictionary)
