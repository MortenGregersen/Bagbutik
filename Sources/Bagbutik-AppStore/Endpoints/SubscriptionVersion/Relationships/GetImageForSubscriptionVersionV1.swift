...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-subscriptionVersions-_id_-image>

     - Parameter id: The id of the requested resource
     - Parameter fields: Fields to return for included related types
     - Returns: A ``Request`` to send to an instance of ``BagbutikService``
     */
    static func getImageForSubscriptionVersionV1(id: String,
                                                 fields: [GetImageForSubscriptionVersionV1.Field]? = nil) -> Request<SubscriptionImageV2Response, ErrorResponse> {
        .init(
...
public enum GetImageForSubscriptionVersionV1 {
    /**
