...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-subscriptionPlanAvailabilities-_id_-availableTerritories>
     ...
     */
    static func listAvailableTerritoriesForSubscriptionPlanAvailabilityV1(id: String,
                                                                          fields: [ListAvailableTerritoriesForSubscriptionPlanAvailabilityV1.Field]? = nil,
...
public enum ListAvailableTerritoriesForSubscriptionPlanAvailabilityV1 {
    /**
