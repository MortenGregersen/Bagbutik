...
public extension Request {
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/get-v1-inAppPurchaseVersions-_id_>
     ...
     */
    static func getInAppPurchaseVersionV1(id: String,
                                          fields: [GetInAppPurchaseVersionV1.Field]? = nil,
                                          includes: [GetInAppPurchaseVersionV1.Include]? = nil,
                                          limits: [GetInAppPurchaseVersionV1.Limit]? = nil) -> Request<InAppPurchaseVersionResponse, ErrorResponse> {
        .init(
...
public enum GetInAppPurchaseVersionV1 {
    /**
