...
public extension Request {
     ...
     */
    static func listOfferCodesForInAppPurchasesV2(id: String,
                                                  fields: [ListOfferCodesForInAppPurchasesV2.Field]? = nil,
                                                  filters: [ListOfferCodesForInAppPurchasesV2.Filter]? = nil,
                                                  includes: [ListOfferCodesForInAppPurchasesV2.Include]? = nil,
                                                  limits: [ListOfferCodesForInAppPurchasesV2.Limit]? = nil) -> Request<InAppPurchaseOfferCodesResponse, ErrorResponse> {
        .init(
...
public enum ListOfferCodesForInAppPurchasesV2 {
    /**
