...
public extension Request {
     ...
     */
    static func listAppStoreVersionExperimentTreatmentsForAppStoreVersionExperimentV2(id: String,
                                                                                      fields: [ListAppStoreVersionExperimentTreatmentsForAppStoreVersionExperimentV2.Field]? = nil,
                                                                                      includes: [ListAppStoreVersionExperimentTreatmentsForAppStoreVersionExperimentV2.Include]? = nil,
                                                                                      limits: [ListAppStoreVersionExperimentTreatmentsForAppStoreVersionExperimentV2.Limit]? = nil) -> Request<AppStoreVersionExperimentTreatmentsResponse, ErrorResponse>
    {
...
public enum ListAppStoreVersionExperimentTreatmentsForAppStoreVersionExperimentV2 {
    /**
