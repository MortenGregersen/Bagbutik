public extension Request {
     ...
     */
    static func getBuildForBuildBetaDetail(id: String,
                                           fields: [GetBuildForBuildBetaDetail.Field]? = nil) -> Request<BuildResponse, ErrorResponse>
    {
        return .init(path: "/v1/buildBetaDetails/\(id)/build", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetBuildForBuildBetaDetail {
    /**
