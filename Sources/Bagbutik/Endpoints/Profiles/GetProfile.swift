public extension Request {
     ...
     */
    static func getProfile(id: String,
                           fields: [GetProfile.Field]? = nil,
                           includes: [GetProfile.Include]? = nil,
                           limits: [GetProfile.Limit]? = nil) -> Request<ProfileResponse, ErrorResponse>
    {
