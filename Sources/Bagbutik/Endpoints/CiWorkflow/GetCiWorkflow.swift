public extension Request {
     ...
     */
    static func getCiWorkflow(id: String,
                              fields: [GetCiWorkflow.Field]? = nil,
                              includes: [GetCiWorkflow.Include]? = nil) -> Request<CiWorkflowResponse, ErrorResponse>
    {
