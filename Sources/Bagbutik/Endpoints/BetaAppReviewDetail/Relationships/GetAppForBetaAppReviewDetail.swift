public extension Request {
     ...
     */
    static func getAppForBetaAppReviewDetail(id: String,
                                             fields: [GetAppForBetaAppReviewDetail.Field]? = nil) -> Request<AppResponse, ErrorResponse>
    {
        return .init(path: "/v1/betaAppReviewDetails/\(id)/app", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetAppForBetaAppReviewDetail {
    /**
