public extension Request {
     ...
     */
    static func getAppStoreVersionExperimentTreatmentLocalization(id: String,
                                                                  fields: [GetAppStoreVersionExperimentTreatmentLocalization.Field]? = nil,
                                                                  includes: [GetAppStoreVersionExperimentTreatmentLocalization.Include]? = nil,
                                                                  limits: [GetAppStoreVersionExperimentTreatmentLocalization.Limit]? = nil) -> Request<AppStoreVersionExperimentTreatmentLocalizationResponse, ErrorResponse>
    {
...
public enum GetAppStoreVersionExperimentTreatmentLocalization {
    /**
