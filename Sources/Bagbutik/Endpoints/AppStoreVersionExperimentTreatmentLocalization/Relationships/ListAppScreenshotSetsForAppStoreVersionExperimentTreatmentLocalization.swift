public extension Request {
     ...
     */
    static func listAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization(id: String,
                                                                                       fields: [ListAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization.Field]? = nil,
                                                                                       filters: [ListAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization.Filter]? = nil,
                                                                                       includes: [ListAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization.Include]? = nil,
                                                                                       limits: [ListAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization.Limit]? = nil) -> Request<AppScreenshotSetsResponse, ErrorResponse>
    {
...
public enum ListAppScreenshotSetsForAppStoreVersionExperimentTreatmentLocalization {
    /**
