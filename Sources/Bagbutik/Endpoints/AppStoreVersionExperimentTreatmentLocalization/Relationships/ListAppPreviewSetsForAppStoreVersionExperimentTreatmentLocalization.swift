public extension Request {
     ...
     */
    static func listAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization(id: String,
                                                                                    fields: [ListAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization.Field]? = nil,
                                                                                    filters: [ListAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization.Filter]? = nil,
                                                                                    includes: [ListAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization.Include]? = nil,
                                                                                    limits: [ListAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization.Limit]? = nil) -> Request<AppPreviewSetsResponse, ErrorResponse>
    {
...
public enum ListAppPreviewSetsForAppStoreVersionExperimentTreatmentLocalization {
    /**
