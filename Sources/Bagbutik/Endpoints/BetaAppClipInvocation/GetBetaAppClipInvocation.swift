public extension Request {
     ...
     */
    static func getBetaAppClipInvocation(id: String,
                                         fields: [GetBetaAppClipInvocation.Field]? = nil,
                                         includes: [GetBetaAppClipInvocation.Include]? = nil,
...
public enum GetBetaAppClipInvocation {
    /**
