public extension Request {
     ...
     */
    static func getSubscriptionOfferCode(id: String,
                                         fields: [GetSubscriptionOfferCode.Field]? = nil,
                                         includes: [GetSubscriptionOfferCode.Include]? = nil,
                                         limits: [GetSubscriptionOfferCode.Limit]? = nil) -> Request<SubscriptionOfferCodeResponse, ErrorResponse>
    {
...
public enum GetSubscriptionOfferCode {
    /**
