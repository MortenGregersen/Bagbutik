public extension Request {
     ...
     */
    static func listCustomCodesForSubscriptionOfferCode(id: String,
                                                        fields: [ListCustomCodesForSubscriptionOfferCode.Field]? = nil,
                                                        includes: [ListCustomCodesForSubscriptionOfferCode.Include]? = nil,
...
public enum ListCustomCodesForSubscriptionOfferCode {
    /**
