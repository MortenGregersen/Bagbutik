public extension Request {
     ...
     */
    static func listPricesForSubscriptionOfferCode(id: String,
                                                   fields: [ListPricesForSubscriptionOfferCode.Field]? = nil,
                                                   filters: [ListPricesForSubscriptionOfferCode.Filter]? = nil,
                                                   includes: [ListPricesForSubscriptionOfferCode.Include]? = nil,
...
public enum ListPricesForSubscriptionOfferCode {
    /**
