public extension Request {
     ...
     */
    static func listOneTimeUseCodesForSubscriptionOfferCode(id: String,
                                                            fields: [ListOneTimeUseCodesForSubscriptionOfferCode.Field]? = nil,
                                                            includes: [ListOneTimeUseCodesForSubscriptionOfferCode.Include]? = nil,
...
public enum ListOneTimeUseCodesForSubscriptionOfferCode {
    /**
