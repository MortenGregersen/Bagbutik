public extension Request {
     ...
     */
    static func getPrimaryCategoryForAppInfo(id: String,
                                             fields: [GetPrimaryCategoryForAppInfo.Field]? = nil) -> Request<AppCategoryResponse, ErrorResponse>
    {
        return .init(path: "/v1/appInfos/\(id)/primaryCategory", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetPrimaryCategoryForAppInfo {
    /**
