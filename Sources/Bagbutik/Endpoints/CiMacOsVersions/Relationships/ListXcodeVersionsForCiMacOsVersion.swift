public extension Request {
     ...
     */
    static func listXcodeVersionsForCiMacOsVersion(id: String,
                                                   fields: [ListXcodeVersionsForCiMacOsVersion.Field]? = nil,
                                                   includes: [ListXcodeVersionsForCiMacOsVersion.Include]? = nil,
                                                   limits: [ListXcodeVersionsForCiMacOsVersion.Limit]? = nil) -> Request<CiXcodeVersionsResponse, ErrorResponse>
    {
...
public enum ListXcodeVersionsForCiMacOsVersion {
    /**
