public extension Request {
     ...
     */
    static func listAppClipAdvancedExperiencesForAppClip(id: String,
                                                         fields: [ListAppClipAdvancedExperiencesForAppClip.Field]? = nil,
                                                         filters: [ListAppClipAdvancedExperiencesForAppClip.Filter]? = nil,
                                                         includes: [ListAppClipAdvancedExperiencesForAppClip.Include]? = nil,
                                                         limits: [ListAppClipAdvancedExperiencesForAppClip.Limit]? = nil) -> Request<AppClipAdvancedExperiencesResponse, ErrorResponse>
    {
...
public enum ListAppClipAdvancedExperiencesForAppClip {
    /**
