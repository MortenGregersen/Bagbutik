public extension Request {
     ...
     */
    static func listSubscriptionsForSubscriptionGroup(id: String,
                                                      fields: [ListSubscriptionsForSubscriptionGroup.Field]? = nil,
                                                      filters: [ListSubscriptionsForSubscriptionGroup.Filter]? = nil,
                                                      includes: [ListSubscriptionsForSubscriptionGroup.Include]? = nil,
                                                      sorts: [ListSubscriptionsForSubscriptionGroup.Sort]? = nil,
                                                      limits: [ListSubscriptionsForSubscriptionGroup.Limit]? = nil) -> Request<SubscriptionsResponse, ErrorResponse>
    {
...
public enum ListSubscriptionsForSubscriptionGroup {
    /**
