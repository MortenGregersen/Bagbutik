public extension Request {
     ...
     */
    static func getSubscriptionGroup(id: String,
                                     fields: [GetSubscriptionGroup.Field]? = nil,
                                     includes: [GetSubscriptionGroup.Include]? = nil,
                                     limits: [GetSubscriptionGroup.Limit]? = nil) -> Request<SubscriptionGroupResponse, ErrorResponse>
    {
...
public enum GetSubscriptionGroup {
    /**
