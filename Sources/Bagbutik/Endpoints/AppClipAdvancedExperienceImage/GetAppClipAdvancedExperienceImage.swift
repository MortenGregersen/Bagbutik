public extension Request {
     ...
     */
    static func getAppClipAdvancedExperienceImage(id: String,
                                                  fields: [GetAppClipAdvancedExperienceImage.Field]? = nil) -> Request<AppClipAdvancedExperienceImageResponse, ErrorResponse>
    {
        return .init(path: "/v1/appClipAdvancedExperienceImages/\(id)", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetAppClipAdvancedExperienceImage {
    /**
