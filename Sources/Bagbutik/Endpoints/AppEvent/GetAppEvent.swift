public extension Request {
     ...
     */
    static func getAppEvent(id: String,
                            fields: [GetAppEvent.Field]? = nil,
                            includes: [GetAppEvent.Include]? = nil,
                            limit: Int? = nil) -> Request<AppEventResponse, ErrorResponse>
    {
        return .init(path: "/v1/appEvents/\(id)", method: .get, parameters: .init(fields: fields,
                                                                                  includes: includes,
                                                                                  limit: limit))
    }
}

public enum GetAppEvent {
    /**
