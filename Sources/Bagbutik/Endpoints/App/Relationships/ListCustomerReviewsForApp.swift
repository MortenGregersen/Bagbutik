public extension Request {
     ...
     */
    static func listCustomerReviewsForApp(id: String,
                                          fields: [ListCustomerReviewsForApp.Field]? = nil,
                                          filters: [ListCustomerReviewsForApp.Filter]? = nil,
                                          exists: [ListCustomerReviewsForApp.Exist]? = nil,
                                          includes: [ListCustomerReviewsForApp.Include]? = nil,
                                          sorts: [ListCustomerReviewsForApp.Sort]? = nil,
...
public enum ListCustomerReviewsForApp {
    /**
