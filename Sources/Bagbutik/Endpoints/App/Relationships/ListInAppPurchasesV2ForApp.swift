public extension Request {
     ...
     */
    static func listInAppPurchasesV2ForApp(id: String,
                                           fields: [ListInAppPurchasesV2ForApp.Field]? = nil,
                                           filters: [ListInAppPurchasesV2ForApp.Filter]? = nil,
                                           includes: [ListInAppPurchasesV2ForApp.Include]? = nil,
                                           sorts: [ListInAppPurchasesV2ForApp.Sort]? = nil,
                                           limits: [ListInAppPurchasesV2ForApp.Limit]? = nil) -> Request<InAppPurchasesV2Response, ErrorResponse>
    {
...
public enum ListInAppPurchasesV2ForApp {
    /**
