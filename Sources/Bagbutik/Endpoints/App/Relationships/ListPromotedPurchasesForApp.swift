public extension Request {
     ...
     */
    static func listPromotedPurchasesForApp(id: String,
                                            fields: [ListPromotedPurchasesForApp.Field]? = nil,
                                            includes: [ListPromotedPurchasesForApp.Include]? = nil,
                                            limits: [ListPromotedPurchasesForApp.Limit]? = nil) -> Request<PromotedPurchasesResponse, ErrorResponse>
    {
...
public enum ListPromotedPurchasesForApp {
    /**
