public extension Request {
     ...
     */
    static func listSubscriptionGroupsForApp(id: String,
                                             fields: [ListSubscriptionGroupsForApp.Field]? = nil,
                                             filters: [ListSubscriptionGroupsForApp.Filter]? = nil,
                                             includes: [ListSubscriptionGroupsForApp.Include]? = nil,
                                             sorts: [ListSubscriptionGroupsForApp.Sort]? = nil,
                                             limits: [ListSubscriptionGroupsForApp.Limit]? = nil) -> Request<SubscriptionGroupsResponse, ErrorResponse>
    {
...
public enum ListSubscriptionGroupsForApp {
    /**
