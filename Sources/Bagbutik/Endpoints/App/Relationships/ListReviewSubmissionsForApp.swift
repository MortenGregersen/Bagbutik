public extension Request {
     ...
     */
    static func listReviewSubmissionsForApp(id: String,
                                            fields: [ListReviewSubmissionsForApp.Field]? = nil,
                                            filters: [ListReviewSubmissionsForApp.Filter]? = nil,
                                            includes: [ListReviewSubmissionsForApp.Include]? = nil,
                                            limits: [ListReviewSubmissionsForApp.Limit]? = nil) -> Request<ReviewSubmissionsResponse, ErrorResponse>
    {
...
public enum ListReviewSubmissionsForApp {
    /**
