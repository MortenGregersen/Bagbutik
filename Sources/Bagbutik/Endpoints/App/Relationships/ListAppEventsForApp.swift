public extension Request {
     ...
     */
    static func listAppEventsForApp(id: String,
                                    fields: [ListAppEventsForApp.Field]? = nil,
                                    filters: [ListAppEventsForApp.Filter]? = nil,
                                    includes: [ListAppEventsForApp.Include]? = nil,
                                    limits: [ListAppEventsForApp.Limit]? = nil) -> Request<AppEventsResponse, ErrorResponse>
    {
...
public enum ListAppEventsForApp {
    /**
