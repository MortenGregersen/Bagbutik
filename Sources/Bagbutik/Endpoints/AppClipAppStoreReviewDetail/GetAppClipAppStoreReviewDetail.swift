public extension Request {
     ...
     */
    static func getAppClipAppStoreReviewDetail(id: String,
                                               fields: [GetAppClipAppStoreReviewDetail.Field]? = nil,
                                               includes: [GetAppClipAppStoreReviewDetail.Include]? = nil) -> Request<AppClipAppStoreReviewDetailResponse, ErrorResponse>
    {
...
public enum GetAppClipAppStoreReviewDetail {
    /**
