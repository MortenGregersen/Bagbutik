public extension Request {
     ...
     */
    static func createAppClipAppStoreReviewDetail(requestBody: AppClipAppStoreReviewDetailCreateRequest) -> Request<AppClipAppStoreReviewDetailResponse, ErrorResponse> {
