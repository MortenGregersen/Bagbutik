public extension Request {
     ...
     */
    static func getAppCustomProductPageLocalization(id: String,
                                                    fields: [GetAppCustomProductPageLocalization.Field]? = nil,
                                                    includes: [GetAppCustomProductPageLocalization.Include]? = nil,
                                                    limits: [GetAppCustomProductPageLocalization.Limit]? = nil) -> Request<AppCustomProductPageLocalizationResponse, ErrorResponse>
    {
...
public enum GetAppCustomProductPageLocalization {
    /**
