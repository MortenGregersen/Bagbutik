public extension Request {
     ...
     */
    static func listManualPricesForInAppPurchasePriceSchedule(id: String,
                                                              fields: [ListManualPricesForInAppPurchasePriceSchedule.Field]? = nil,
                                                              filters: [ListManualPricesForInAppPurchasePriceSchedule.Filter]? = nil,
                                                              includes: [ListManualPricesForInAppPurchasePriceSchedule.Include]? = nil,
...
public enum ListManualPricesForInAppPurchasePriceSchedule {
    /**
