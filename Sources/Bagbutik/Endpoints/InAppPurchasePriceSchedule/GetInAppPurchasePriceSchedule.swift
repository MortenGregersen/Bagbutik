public extension Request {
     ...
     */
    static func getInAppPurchasePriceSchedule(id: String,
                                              fields: [GetInAppPurchasePriceSchedule.Field]? = nil,
                                              includes: [GetInAppPurchasePriceSchedule.Include]? = nil,
...
public enum GetInAppPurchasePriceSchedule {
    /**
