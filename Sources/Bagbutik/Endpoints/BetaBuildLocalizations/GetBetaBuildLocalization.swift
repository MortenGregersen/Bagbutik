public extension Request {
     ...
     */
    static func getBetaBuildLocalization(id: String,
                                         fields: [GetBetaBuildLocalization.Field]? = nil,
                                         includes: [GetBetaBuildLocalization.Include]? = nil) -> Request<BetaBuildLocalizationResponse, ErrorResponse>
    {
