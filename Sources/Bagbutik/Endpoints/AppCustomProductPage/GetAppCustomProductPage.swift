public extension Request {
     ...
     */
    static func getAppCustomProductPage(id: String,
                                        fields: [GetAppCustomProductPage.Field]? = nil,
                                        includes: [GetAppCustomProductPage.Include]? = nil,
...
public enum GetAppCustomProductPage {
    /**
