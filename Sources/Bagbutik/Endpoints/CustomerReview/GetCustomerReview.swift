public extension Request {
     ...
     */
    static func getCustomerReview(id: String,
                                  fields: [GetCustomerReview.Field]? = nil,
                                  includes: [GetCustomerReview.Include]? = nil) -> Request<CustomerReviewResponse, ErrorResponse>
    {
