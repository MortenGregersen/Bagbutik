public extension Request {
     ...
     */
    static func getResponseForCustomerReview(id: String,
                                             fields: [GetResponseForCustomerReview.Field]? = nil,
                                             includes: [GetResponseForCustomerReview.Include]? = nil) -> Request<CustomerReviewResponseV1Response, ErrorResponse>
    {
        return .init(path: "/v1/customerReviews/\(id)/response", method: .get, parameters: .init(fields: fields,
                                                                                                 includes: includes))
    }
}

public enum GetResponseForCustomerReview {
    /**
