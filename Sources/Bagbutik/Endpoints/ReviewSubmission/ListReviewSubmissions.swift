public extension Request {
     ...
     */
    static func listReviewSubmissions(fields: [ListReviewSubmissions.Field]? = nil,
                                      filters: [ListReviewSubmissions.Filter]? = nil,
                                      includes: [ListReviewSubmissions.Include]? = nil,
                                      limits: [ListReviewSubmissions.Limit]? = nil) -> Request<ReviewSubmissionsResponse, ErrorResponse>
    {
...
public enum ListReviewSubmissions {
    /**
