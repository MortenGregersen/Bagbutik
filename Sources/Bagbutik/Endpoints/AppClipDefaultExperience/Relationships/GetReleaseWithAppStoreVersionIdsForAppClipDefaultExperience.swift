public extension Request {
     ...
     */
    static func getReleaseWithAppStoreVersionIdsForAppClipDefaultExperience(id: String) -> Request<AppClipDefaultExperienceReleaseWithAppStoreVersionLinkageResponse, ErrorResponse> {
