public extension Request {
     ...
     */
    static func getAppStoreReviewScreenshotForInAppPurchase(id: String,
                                                            fields: [GetAppStoreReviewScreenshotForInAppPurchase.Field]? = nil,
                                                            includes: [GetAppStoreReviewScreenshotForInAppPurchase.Include]? = nil) -> Request<InAppPurchaseAppStoreReviewScreenshotResponse, ErrorResponse>
    {
...
public enum GetAppStoreReviewScreenshotForInAppPurchase {
    /**
