public extension Request {
     ...
     */
    static func listPricePointsForInAppPurchase(id: String,
                                                fields: [ListPricePointsForInAppPurchase.Field]? = nil,
                                                filters: [ListPricePointsForInAppPurchase.Filter]? = nil,
                                                includes: [ListPricePointsForInAppPurchase.Include]? = nil,
...
public enum ListPricePointsForInAppPurchase {
    /**
