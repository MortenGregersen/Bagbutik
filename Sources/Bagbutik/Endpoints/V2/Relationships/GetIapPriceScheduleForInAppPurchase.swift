public extension Request {
     ...
     */
    static func getIapPriceScheduleForInAppPurchase(id: String,
                                                    fields: [GetIapPriceScheduleForInAppPurchase.Field]? = nil,
                                                    includes: [GetIapPriceScheduleForInAppPurchase.Include]? = nil,
...
public enum GetIapPriceScheduleForInAppPurchase {
    /**
