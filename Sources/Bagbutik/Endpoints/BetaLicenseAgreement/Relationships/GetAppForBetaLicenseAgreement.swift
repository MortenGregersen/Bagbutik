public extension Request {
     ...
     */
    static func getAppForBetaLicenseAgreement(id: String,
                                              fields: [GetAppForBetaLicenseAgreement.Field]? = nil) -> Request<AppResponse, ErrorResponse>
    {
        return .init(path: "/v1/betaLicenseAgreements/\(id)/app", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetAppForBetaLicenseAgreement {
    /**
