public extension Request {
     ...
     */
    static func getSubscription(id: String,
                                fields: [GetSubscription.Field]? = nil,
                                includes: [GetSubscription.Include]? = nil,
                                limits: [GetSubscription.Limit]? = nil) -> Request<SubscriptionResponse, ErrorResponse>
    {
