public extension Request {
     ...
     */
    static func listOfferCodesForSubscription(id: String,
                                              fields: [ListOfferCodesForSubscription.Field]? = nil,
                                              filters: [ListOfferCodesForSubscription.Filter]? = nil,
                                              includes: [ListOfferCodesForSubscription.Include]? = nil,
                                              limits: [ListOfferCodesForSubscription.Limit]? = nil) -> Request<SubscriptionOfferCodesResponse, ErrorResponse>
    {
...
public enum ListOfferCodesForSubscription {
    /**
