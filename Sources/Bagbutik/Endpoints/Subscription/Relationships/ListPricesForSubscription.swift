public extension Request {
     ...
     */
    static func listPricesForSubscription(id: String,
                                          fields: [ListPricesForSubscription.Field]? = nil,
                                          filters: [ListPricesForSubscription.Filter]? = nil,
                                          includes: [ListPricesForSubscription.Include]? = nil,
                                          limit: Int? = nil) -> Request<SubscriptionPricesResponse, ErrorResponse>
    {
        return .init(path: "/v1/subscriptions/\(id)/prices", method: .get, parameters: .init(fields: fields,
                                                                                             filters: filters,
                                                                                             includes: includes,
                                                                                             limit: limit))
    }
...
public enum ListPricesForSubscription {
    /**
