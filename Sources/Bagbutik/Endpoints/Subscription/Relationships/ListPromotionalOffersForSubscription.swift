public extension Request {
     ...
     */
    static func listPromotionalOffersForSubscription(id: String,
                                                     fields: [ListPromotionalOffersForSubscription.Field]? = nil,
                                                     filters: [ListPromotionalOffersForSubscription.Filter]? = nil,
                                                     includes: [ListPromotionalOffersForSubscription.Include]? = nil,
                                                     limits: [ListPromotionalOffersForSubscription.Limit]? = nil) -> Request<SubscriptionPromotionalOffersResponse, ErrorResponse>
    {
...
public enum ListPromotionalOffersForSubscription {
    /**
