public extension Request {
     ...
     */
    static func getPromotedPurchaseForSubscription(id: String,
                                                   fields: [GetPromotedPurchaseForSubscription.Field]? = nil,
                                                   includes: [GetPromotedPurchaseForSubscription.Include]? = nil,
                                                   limit: Int? = nil) -> Request<PromotedPurchaseResponse, ErrorResponse>
    {
        return .init(path: "/v1/subscriptions/\(id)/promotedPurchase", method: .get, parameters: .init(fields: fields,
                                                                                                       includes: includes,
                                                                                                       limit: limit))
    }
}

public enum GetPromotedPurchaseForSubscription {
    /**
