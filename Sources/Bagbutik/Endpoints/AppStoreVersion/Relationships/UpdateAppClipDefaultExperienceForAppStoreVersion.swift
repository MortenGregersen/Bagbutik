public extension Request {
     ...
     */
    static func updateAppClipDefaultExperienceForAppStoreVersion(id: String,
                                                                 requestBody: AppStoreVersionAppClipDefaultExperienceLinkageRequest) -> Request<EmptyResponse, ErrorResponse>
    {
        return .init(path: "/v1/appStoreVersions/\(id)/relationships/appClipDefaultExperience", method: .patch, requestBody: requestBody)
    }
}
