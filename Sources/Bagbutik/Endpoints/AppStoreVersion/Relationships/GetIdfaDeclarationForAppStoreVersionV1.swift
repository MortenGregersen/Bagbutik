public extension Request {
    ...
    static func getIdfaDeclarationForAppStoreVersionV1(id: String,
                                                       fields: [GetIdfaDeclarationForAppStoreVersionV1.Field]? = nil) -> Request<IdfaDeclarationResponse, ErrorResponse>
    {
        return .init(path: "/v1/appStoreVersions/\(id)/idfaDeclaration", method: .get, parameters: .init(fields: fields))
    }
}

public enum GetIdfaDeclarationForAppStoreVersionV1 {
    /**
