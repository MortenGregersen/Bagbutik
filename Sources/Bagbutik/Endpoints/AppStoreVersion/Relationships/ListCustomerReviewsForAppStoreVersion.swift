public extension Request {
     ...
     */
    static func listCustomerReviewsForAppStoreVersion(id: String,
                                                      fields: [ListCustomerReviewsForAppStoreVersion.Field]? = nil,
                                                      filters: [ListCustomerReviewsForAppStoreVersion.Filter]? = nil,
                                                      exists: [ListCustomerReviewsForAppStoreVersion.Exist]? = nil,
                                                      includes: [ListCustomerReviewsForAppStoreVersion.Include]? = nil,
                                                      sorts: [ListCustomerReviewsForAppStoreVersion.Sort]? = nil,
...
public enum ListCustomerReviewsForAppStoreVersion {
    /**
