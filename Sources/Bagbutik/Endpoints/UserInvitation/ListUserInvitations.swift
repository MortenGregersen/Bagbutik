public extension Request {
     ...
     */
    static func listUserInvitations(fields: [ListUserInvitations.Field]? = nil,
                                    filters: [ListUserInvitations.Filter]? = nil,
                                    includes: [ListUserInvitations.Include]? = nil,
                                    sorts: [ListUserInvitations.Sort]? = nil,
                                    limits: [ListUserInvitations.Limit]? = nil) -> Request<UserInvitationsResponse, ErrorResponse>
    {
...
public enum ListUserInvitations {
    /**
