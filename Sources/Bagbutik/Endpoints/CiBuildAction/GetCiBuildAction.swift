public extension Request {
     ...
     */
    static func getCiBuildAction(id: String,
                                 fields: [GetCiBuildAction.Field]? = nil,
                                 includes: [GetCiBuildAction.Include]? = nil) -> Request<CiBuildActionResponse, ErrorResponse>
    {
