public extension Request {
     ...
     */
    static func listScmRepositories(fields: [ListScmRepositories.Field]? = nil,
                                    filters: [ListScmRepositories.Filter]? = nil,
                                    includes: [ListScmRepositories.Include]? = nil,
...
public enum ListScmRepositories {
    /**
