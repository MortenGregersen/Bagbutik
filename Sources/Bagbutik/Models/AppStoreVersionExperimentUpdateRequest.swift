...
public struct AppStoreVersionExperimentUpdateRequest: Codable, RequestBody {
    /// The resource data.
    ...
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/appstoreversionexperimentupdaterequest/data>
     */
