...
public struct PromotedPurchaseUpdateRequest: Codable, RequestBody {
    ...
    /**
     ...
     Full documentation:
     <https://developer.apple.com/documentation/appstoreconnectapi/promotedpurchaseupdaterequest/data>
     */
