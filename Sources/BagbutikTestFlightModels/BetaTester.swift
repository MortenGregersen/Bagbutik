...
/**
 ...
 [`object BetaTester.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaTester/Attributes-data.dictionary)

 Attributes that describe a beta tester resource.

 [`string BetaInviteType`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaInviteType)

 String that indicates how you offer a beta invitation.

 [`string BetaTesterState`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaTesterState)

 String that describes the state of a beta tester.

 [`object BetaTester.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaTester/Relationships-data.dictionary)
