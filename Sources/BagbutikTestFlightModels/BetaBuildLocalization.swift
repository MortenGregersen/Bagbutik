...
/**
 ...
 [`object BetaBuildLocalization.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaBuildLocalization/Attributes-data.dictionary)

 Attributes that describe a Beta Build Localizations resource.

 [`object BetaBuildLocalization.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaBuildLocalization/Relationships-data.dictionary)
