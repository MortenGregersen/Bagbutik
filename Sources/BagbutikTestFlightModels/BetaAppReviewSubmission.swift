...
/**
 ...
 [`object BetaAppReviewSubmission.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaAppReviewSubmission/Attributes-data.dictionary)

 Attributes that describe a Beta App Review Submissions resource.

 [`object BetaAppReviewSubmission.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaAppReviewSubmission/Relationships-data.dictionary)
