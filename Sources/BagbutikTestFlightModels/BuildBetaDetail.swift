...
/**
 ...
 [`object BuildBetaDetail.Attributes`](https://developer.apple.com/documentation/AppStoreConnectAPI/BuildBetaDetail/Attributes-data.dictionary)

 Attributes that describe a Build Beta Details resource.

 [`object BuildBetaDetail.Relationships`](https://developer.apple.com/documentation/AppStoreConnectAPI/BuildBetaDetail/Relationships-data.dictionary)
