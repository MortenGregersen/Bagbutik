...
/**
 ...
 [`object BetaAppReviewDetailUpdateRequest.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/BetaAppReviewDetailUpdateRequest/Data-data.dictionary)
