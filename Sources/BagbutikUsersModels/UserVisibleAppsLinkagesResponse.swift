...
/**
 ...
 [`object UserVisibleAppsLinkagesResponse.Data`](https://developer.apple.com/documentation/AppStoreConnectAPI/UserVisibleAppsLinkagesResponse/Data-data.dictionary)

 The data element of the response body.

 ## See Also

 [`Get all visible app resource ids for a user`](https://developer.apple.com/documentation/AppStoreConnectAPI/GET-v1-users-_id_-relationships-visibleApps)
