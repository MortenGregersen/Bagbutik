...
### Using Bagbutik as a source package (recommended)
...
### Using the XCFramework (optional)

Bagbutik releases also include a prebuilt **XCFramework** (`Bagbutik.xcframework.zip`) for cases where you prefer a binary dependency, such as:
