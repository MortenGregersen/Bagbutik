...
* `Bagbutik-AppStore`, `Bagbutik-TestFlight`, `BagbutikReporting`, and the other product modules contain generated endpoint builders grouped by App Store Connect domain.
