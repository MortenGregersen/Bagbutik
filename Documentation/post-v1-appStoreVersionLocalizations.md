<!--
{
  ...
  "identifier" : "/documentation/AppStoreConnectAPI/POST-v1-appStoreVersionLocalizations",
  ...
  "symbol" : {
    ...
    "preciseIdentifier" : "rest:app_store_connect_api:post:v1-appStoreVersionLocalizations"
  },
...
Use this endpoint to add localized version information for a new locale. Be sure to use [`Create an app info localization`](/documentation/AppStoreConnectAPI/POST-v1-appInfoLocalizations) to add the same locale to the version as well.
